...
const HELP_ABOUT: (&str, &str) = ("**Command: /about**", include_str!("listofcmds/about.md"));
const HELP_GAME: (&str, &str) = ("**Command: /game**", include_str!("listofcmds/game.md"));
const HELP_GAMES: (&str, &str) = ("**Command: /games**", include_str!("listofcmds/games.md"));
const HELP_MODS: (&str, &str) = ("**Command: /mods**", include_str!("listofcmds/mods.md"));
const HELP_POPULAR: (&str, &str) = ("**Command: /popular**", include_str!("listofcmds/popular.md"));
const HELP_SUBS_LIST: (&str, &str) = ("**Command: /subs list**", include_str!("listofcmds/subs-list.md"));
const HELP_SUBS_ADD: (&str, &str) = ("**Command: /subs add**", include_str!("listofcmds/subs-add.md"));
const HELP_SUBS_RM: (&str, &str) = ("**Command: /subs rm**", include_str!("listofcmds/subs-rm.md"));
const HELP_SUBS_MODS_MUTED: (&str, &str) = (
    "**Command: /subs mods muted**",
    include_str!("listofcmds/subs-mods-muted.md"),
);
const HELP_SUBS_MODS_MUTE: (&str, &str) = (
    "**Command: /subs mods mute**",
    include_str!("listofcmds/subs-mods-mute.md"),
);
const HELP_SUBS_MODS_UNMUTE: (&str, &str) = (
    "**Command: /subs mods unmute**",
    include_str!("listofcmds/subs-mods-unmute.md"),
);
const HELP_SUBS_USERS_MUTED: (&str, &str) = (
    "**Command: /subs users muted**",
    include_str!("listofcmds/subs-users-muted.md"),
);
const HELP_SUBS_USERS_MUTE: (&str, &str) = (
    "**Command: /subs users mute**",
    include_str!("listofcmds/subs-users-mute.md"),
);
const HELP_SUBS_USERS_UNMUTE: (&str, &str) = (
    "**Command: /subs users unmute**",
    include_str!("listofcmds/subs-users-unmute.md"),
);
